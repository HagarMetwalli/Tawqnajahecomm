    ...
    children: [

      {
        ...
        element: localStorage.getItem("token")
          ? <Navigate to="/accounttype" />
          : <Navigate to="/login" />
      },
      { path: 'login', element: <Login /> },
      { path: 'accounttype', element: <PrivateRoute><AccountType /></PrivateRoute> },
      { path: 'home', element: <PrivateRoute><Home /></PrivateRoute> },
      { path: 'logoutconfirm', element: <PrivateRoute><LogoutConfirm /></PrivateRoute> },
      ...
      { path: 'confirmedorders', element: <PrivateRoute><ConfirmedOrders /></PrivateRoute> },
